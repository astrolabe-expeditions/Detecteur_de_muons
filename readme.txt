This project is an muon detector used in the Cosmic Sail (citizen sciences program of Astrolabe Expeditions).

The Sensors is an evolution of "CosmicWatch-Desktop-Muon-Detector" published by MIT.
see project description on : http://www.cosmicwatch.lns.mit.edu/detector#cosmicwatch
...
This new version, developed by Astrolabe Expeditions and My Human Kit , has made it possible to produce and significantly improve the architecture of the sensor 
and its code:
...
Great thanks to My humans kit teams for this work !
